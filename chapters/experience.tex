...
La keyword ORDER BY permette riordinare le righe risultanti da una query in base a specifiche condizioni, sia in modo ascendente che discendente.
...
ognuno di essi può essere una colonna o una funzione. Inoltre ognuno per ognuno di questi è necessario decidere se l'ordinamento avviene in modo ascendete o discendente e come debbano
essere ordinati i valori pari a NULL.
...
\`E inoltre possibile una forma del tipo \verb+ORDER BY _costante_numerica_+ dove la costante numerica presente viene utilizzata come indice della corrispondente colonna proiettata. Tale
